...
# Script para iniciar Deep Research con configuración local

echo "🚀 Iniciando Deep Research con API local y DuckDuckGo..."
...
# Ejecutar el servidor LangGraph
echo "🎯 Iniciando servidor LangGraph..."
